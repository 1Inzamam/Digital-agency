...
const OverlapContents = () => {
  return (
    <div
      className="absolute transform -translate-x-1/2 left-1/2 -top-50 w-9/12 h-95 mx-auto bg-cover bg-center bg-no-repeat rounded-2xl"
      ...
      <div className="bg-secondary/80 w-full h-full rounded-2xl text-white flex items-center">
        ...
        <div className="p-6 xl:p-13 space-y-5">
          ...
          <p className="w-full xl:w-130 text-sm md:text-base">
            Reach out to our team of experts, and we'll get back to you promptly
...
export default OverlapContents;
